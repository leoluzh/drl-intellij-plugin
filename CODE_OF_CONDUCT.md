...
reported to the maintainers by opening a confidential report via a private
channel (e.g. a direct message to a maintainer, or GitHub's private
vulnerability/abuse reporting where available). All complaints will be
